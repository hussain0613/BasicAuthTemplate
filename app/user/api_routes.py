...
logout, get_all_actions, get_actions, request_signup)
...
user_api_rt.post("/request_signup/", name='user.api.request_signup')(request_signup)
...
user_api_rt.get('/get_actions/{username}')(get_actions)
user_api_rt.get('/get_actions/')(get_all_actions)
