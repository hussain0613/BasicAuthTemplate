...
user_api_rt.get("/", name='user.api.dashboard')(dahsboard)
...
user_api_rt.get("/token/", name='user.api.login')(login_params)
user_api_rt.post("/token/", name='user.api.login')(login_form)
user_api_rt.put("/token/",  name='user.api.login')(login_json)
user_api_rt.get("/logout", name='user.api.logout')(logout)
